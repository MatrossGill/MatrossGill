...
| HTML    | create, structure, and format the content of web pages                                           | [html](https://en.wikipedia.org/wiki/HTML)     |
| CSS     | to control the visual presentation, layout, and design of web pages written in HTML              | [css](https://en.wikipedia.org/wiki/CSS)       |
###Task list###
- [x] Git and GitHub
